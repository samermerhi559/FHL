...
export const mockSections: SectionConfig[] = [
  ...
  },
  {
    ...
    status: 'warning',
    kpis: [
      { label: 'FX Exposure', value: '$12.4M', change: 8.5, trend: 'up', status: 'warning' },
  ...
  },
  {
    ...
    status: 'critical',
    kpis: [
      { label: 'Top 5 Customers', value: '58%', change: 4.2, trend: 'up', status: 'critical' },
      { label: 'Top Supplier', value: '32%', change: 2.1, trend: 'up', status: 'warning' },
    ],
    sparklineData: [52, 53, 54, 55, 57, 58, 58],
  },
  {
    id: 'alerts',
    name: 'Alerts',
    ...
    status: 'warning',
    kpis: [
      { label: 'Active Alerts', value: '12', status: 'warning' },
  ...
  },
  {
    ...
    status: 'healthy',
    kpis: [
      { label: 'Last Refresh', value: '2m ago' },
      { label: 'Data Quality', value: '99.2%', status: 'healthy' },
    ],
    sparklineData: [98, 98.5, 99, 99.1, 99, 99.2, 99.2],
  },
];
...
export const mockAlerts: Alert[] = [
  {
    ...
    description: 'Top 5 customers now represent 58% of revenue, exceeding policy limit of 55%',
